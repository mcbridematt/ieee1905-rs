    ...
    for neighbor in neighbors {
        ...
        if include_rx {
            let pair = LinkMetricRxPair {
                ...
                packet_errors: to_u32_sat(interface.link_stats.rx_errors),
                transmitted_packets: to_u32_sat(interface.link_stats.rx_packets),
                rssi: 0xFF, // FIXME hardcoded for now
            };
        ...
        if include_tx {
            let pair = LinkMetricTxPair {
                ...
                packet_errors: to_u32_sat(interface.link_stats.tx_errors),
                transmitted_packets: to_u32_sat(interface.link_stats.tx_packets),
                mac_throughput_capacity: 0, // TODO use phy_rate here
                link_availability: 0,       // TODO
                phy_rate: to_u16_sat(interface.phy_rate.unwrap_or_default() / 1_000_000),
            };
